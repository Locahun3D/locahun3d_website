 ...
 *             ※ --faint の極小メタ文字（日付・所要時間・COMING SOON・WORKFLOW 帯）は
 *               かつて rgba(255,255,255,.36) = 3.06〜3.28:1 で AA 未満だったが、
 *               2026-08-16 に rgba(255,255,255,.55) = 6.27:1 へ引き上げ済み
 *               （works_dark_blue.py の色マップ）。現在 24 ページすべてで
 *               inherited-faint=0。この別枠は退行検知用に残してある（非ゼロなら巻き戻し）。
